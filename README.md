...
| `make deploy-prod ["title"]`            | Open or refresh the development→main sync PR summarizing PRs merged into development since the last sync; optional quoted title overrides auto-generation; does not merge (squash-merge into `main` stays manual) |
